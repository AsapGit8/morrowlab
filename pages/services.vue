<template>
  ...
  // SEO
  useHead({
    title: 'Services - MorrowLab Studio',
    meta: [
      { name: 'description', content: 'Learn about MorrowLab, a premium web development studio specializing in modern websites with animations and 3D elements.' }
    ]
  })
  </script>
