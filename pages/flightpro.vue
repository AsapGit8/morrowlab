...
useHead({
  title: 'FlightPro Case Study - MorrowLab Studio',
  meta: [
    {
      name: 'description',
      content:
        'See how MorrowLab helped FlightPro with a custom web development solution featuring modern design and functionality.',
    },
  ],
});
</script>
