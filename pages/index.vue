...
// SEO
useHead({
  title: 'MorrowLab - Web Development Studio',
  meta: [
    {
      name: 'description',
      content:
        'MorrowLab builds high-performing websites with fluid animations, immersive 3D elements, and impactful branding. Designed to captivate and built to last for years.',
    },
  ],
});
</script>
