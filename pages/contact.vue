...
// SEO
useHead({
  title: 'Contact - MorrowLab Studio',
  meta: [
    { name: 'description', content: 'Get in touch with MorrowLab for high-quality web development services. Book a 15-minute consultation today.' }
  ]
})
</script>
